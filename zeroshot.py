...
json_input_path = "object_list.json"  # Replace this with your actual path
with open(json_input_path, "r") as f:
    task_list = json.load(f)

# Extract object names
object_names = [task["object"] for task in task_list]

# Create output directory
os.makedirs("bounding_box", exist_ok=True)
...
try:
    ...
    # Capture one frame (use same frame for all detections)
    ...
    for obj_name in object_names:
        ...
        if boxes.numel() == 0:
            print(f"No objects detected for: {obj_name}")
        else:
            # Get best detection
            ...
            json_path = os.path.join("bounding_box", f"{obj_name}.json")
    ...
    # Show final image with all boxes
