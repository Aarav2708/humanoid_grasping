...
# ---------- Step 3: Iterate through bounding_box folder ----------
bounding_box_dir = "bounding_box"
output_dir = "segmented_waypoints"
...
for filename in os.listdir(bounding_box_dir):
    if filename.endswith(".json"):
        ...
        print(f"[INFO] Segmenting object from: {filename}")
        ...
        # ---------- Step 5: Extract and save contours as waypoints ----------
        ...
        # ---------- Step 6: Optionally display result ----------
        ...
        cv2.imshow(f"Segmentation - {filename}", cv2.cvtColor(image_to_draw, cv2.COLOR_RGB2BGR))
